...
export const ReplayIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0 8.25 8.25 0 000-11.667l-3.182-3.182m0 0V2.985M5.977 2.985h4.992m0 0L5.977 9.348" />
  </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 011.23-5.463l.943-1.886a1.5 1.5 0 012.656 0l.943 1.886A9.75 9.75 0 0116.5 18.75z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75l-2.625-5.25a.75.75 0 00-1.35 0L13.5 12.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75L7.125 7.5a.75.75 0 011.35 0L10.5 12.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75v-3.75" />
  </svg>
);
